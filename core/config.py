...
class ConfigManager:
    public_keys = {
        ...
        "thread_auto_close_response": "This ticket has been closed automatically due to inactivity after {timeout}.",
        ...
        "thread_close_title": "Your ticket has been marked as complete.",
