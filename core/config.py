...
class ConfigManager:
    public_keys = {
        ...
        "thread_auto_close_response": "This ticker has been closed automatically due to inactivity after {timeout}.",
        "thread_creation_response": "Before we can attach an agent to the ticket, please choose one of the following options so we can best direct your request.    ``Orders`` ``General Support`` ``USD Payments`` ``Membership Services`` ``Diamond+ Support`` ``Misc.``",
        "thread_creation_footer": "Your message has been recieved.",
        "thread_contact_silently": False,
        "thread_self_closable_creation_footer": "Click the lock to close the ticket",
        "thread_creation_contact_title": "A support ticket has been created!",
        "thread_creation_self_contact_response": "Your support request has been recieved",
        "thread_creation_contact_response": "{creator.name} has started a ticket with you.",
        "thread_creation_title": "Thanks for contacting our Customer Concierge",
        "thread_close_footer": "This ticket has been closed/",
        "thread_close_title": "Your ticker has been marked as complete.",
        "thread_close_response": "{closer.mention} has closed your ticket today.",
        "thread_self_close_response": "You marked this ticket as closed.",
        "thread_move_title": "Your ticket has been moved.",
        "thread_move_notify": False,
        "thread_move_notify_mods": False,
        "thread_move_response": "This ticket has been moved.",
        ...
        "disabled_new_thread_response": "We are not accepting new tickets. If this is an urgent matter please message Steve directly.",
        ...
        # group conversations
        "private_added_to_group_title": "New ticket (Group)",
        "private_added_to_group_response": "{moderator.name} has added you to a new ticket.",
        "private_added_to_group_description_anon": "A moderator has added you to a new ticket.",
        "public_added_to_group_title": "New User",
        "public_added_to_group_response": "{moderator.name} has added {users} to the support ticket.",
        "public_added_to_group_description_anon": "A moderator has added {users} to the support ticket.",
        "private_removed_from_group_title": "Removed From ticket (Group)",
        "private_removed_from_group_response": "{moderator.name} has removed you from the support ticket.",
        "private_removed_from_group_description_anon": "A moderator has removed you from the support ticket.",
        "public_removed_from_group_title": "User Removed",
        "public_removed_from_group_response": "{moderator.name} has removed {users} from the support ticket.",
        "public_removed_from_group_description_anon": "A moderator has removed {users} from the support ticket.",
        # moderation
